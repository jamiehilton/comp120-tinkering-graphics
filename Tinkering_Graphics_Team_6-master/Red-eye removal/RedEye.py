...
"""
    ...
    All credit goes to original author. I have only put the code into a Python module
    I also fixed an error where the variable mean would stay as a float64. I fixed this by
    changing:
        mean = [:, :, numpy.newaxis]
    to
...
def RemoveRedEyes(Image_Path,Cascade_Classifier_Path):
    ...
    mask=int(0)
    """Mask the eyes in the image(This makes the eyes white with the rest of the image black)"""
    for (x, y, w, h) in eyes:
